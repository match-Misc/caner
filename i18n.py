...
def get_marking_info(language):
    ...
    return {
        "v": {"emoji": "🥕", "title": titles["v"]},
        "x": {"emoji": "🥦", "title": titles["x"]},
        "g": {"emoji": "🐔", "title": titles["g"]},
        "s": {"emoji": "🐷", "title": titles["s"]},
        "f": {"emoji": "🐟", "title": titles["f"]},
        "r": {"emoji": "🐮", "title": titles["r"]},
        "a": {"emoji": "🍺", "title": titles["a"]},
        "26": {"emoji": "🥛", "title": titles["26"]},
        "22": {"emoji": "🥚", "title": titles["22"]},
        "20a": {"emoji": "🌾", "title": titles["20a"]},
        "q": {"title": titles["q"], "images": ["/static/img/nds.png"]},
    }
